...
CREATE TABLE IF NOT EXISTS `pateron`.`siswa_buy_product` (
  ...
  `proof_of_pyment1` BLOB NOT NULL,
  `proof_of_payment2` BLOB NULL,
  `proof_of_payment3` BLOB NULL,
  `proof_of_payment4` BLOB NULL,
  `proof_of_payment5` BLOB NULL,
